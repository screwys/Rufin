...
use ui_shared::artwork::presentation::add_album_seed_gradient_class;
use ui_shared::artwork::{ArtworkTile, CoverGroupProjection, LARGE_COVER_SIZE};
use ui_shared::controls::{ActionButtonVariant, configure_action_button, icon_button};
use ui_shared::controls::{DELETE_ICON, PLAY_LATER_ICON, PLAY_NEXT_ICON};
use ui_shared::interactions::{ContextMenuOpen, RADIO_ICON};
use ui_shared::layout::width_allocation_owner;
use ui_shared::localization::bind_label_text_with;
...
mod showcase_imp {
    ...
    pub struct DetailShowcaseView {
        #[template_child]
        pub cover_column: TemplateChild<gtk::Box>,
        #[template_child]
        pub cover_host: TemplateChild<gtk::Box>,
        #[template_child]
        pub external_links: TemplateChild<gtk::Box>,
        #[template_child]
        pub metadata: TemplateChild<gtk::Box>,
        #[template_child]
        pub text_stack: TemplateChild<gtk::Box>,
        #[template_child]
        pub kind_row: TemplateChild<gtk::Box>,
        #[template_child]
        pub kind: TemplateChild<gtk::Label>,
        #[template_child]
        pub kind_controls: TemplateChild<gtk::Box>,
        #[template_child]
        ...
        #[template_child]
        pub summary_item_0: TemplateChild<gtk::Box>,
        #[template_child]
        pub summary_icon_0: TemplateChild<gtk::Image>,
        #[template_child]
        pub summary_label_0: TemplateChild<gtk::Label>,
        #[template_child]
        pub summary_item_1: TemplateChild<gtk::Box>,
        #[template_child]
        pub summary_icon_1: TemplateChild<gtk::Image>,
        #[template_child]
        pub summary_label_1: TemplateChild<gtk::Label>,
        #[template_child]
...
glib::wrapper! {
    pub struct DetailShowcaseView(ObjectSubclass<showcase_imp::DetailShowcaseView>)
...
impl DetailShowcaseView {
    ...
    pub fn replace_summary(&self, values: &[(&str, String)]) {
        let items = [
            (
    ...
    pub fn replace_external_links(&self, links: Option<gtk::Widget>) {
    ...
    pub fn add_external_links_class(&self, class: &'static str) {
...
pub struct MediaShowcase {
    pub view: DetailShowcaseView,
    pub initial_width: i32,
    pub cover: MediaCoverProjection,
    pub cover_controls: CoverHoverControls,
    pub context_menu: Option<ContextMenuOpen>,
    pub actions_min_cover_size: Option<i32>,
}
...
pub struct CollectionDetailShowcase {
    pub view: DetailShowcaseView,
    pub initial_width: i32,
    pub compact_spacing: i32,
    pub wide_spacing: i32,
...
impl MediaShowcasePresentation {
    ...
    fn resize_cover(&self, width: i32) {
        ...
        let cover_size = crate::route_layout::detail_showcase_cover_size(width);
...
pub fn detail_action_button(icon_name: &str, label: &str) -> gtk::Button {
...
pub fn detail_radio_button() -> gtk::Button {
    let button = gtk::Button::new();
    button.add_css_class("flat");
...
pub fn detail_playback_controls(
    actions: &gtk::Box,
    play_label: &str,
    ...
    let primary = detail_primary_action_button(ui_shared::controls::PLAY_ICON, "Play");
...
#[derive(Clone)]
pub struct MediaCoverProjection {
    button: gtk::Button,
    tile: ArtworkTile,
    size: Rc<Cell<i32>>,
...
impl MediaCoverProjection {
    ...
    pub fn replace(&self, shell: &Rc<CatalogUi>, candidates: ArtworkBinding) {
...
pub fn home_album_cover_projection(
    shell: &Rc<CatalogUi>,
    album: &AlbumRow,
    size: i32,
) -> MediaCoverProjection {
...
fn media_cover_projection_with_open(
    ...
    size: i32,
    cover_class: &str,
    open: impl Fn(&Rc<CatalogUi>, ArtworkBinding) + 'static,
) -> MediaCoverProjection {
    ...
    shell
        .artwork
        .bind_artwork_tile(&tile, candidates.clone(), render_size, fetch_size);
...
pub fn fit_detail_text(label: &gtk::Label, text: &str) {
