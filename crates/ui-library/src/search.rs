...
use ui_shared::recycled_cells::{RecycledMergedCell, RecycledTextCell, list_cell};
use ui_shared::route::CollectionCategory;
...
impl SearchRouteProjection {
    ...
    fn sort_model(&self, category: CollectionCategory) {
        ...
        let mut items = (0..model.n_items())
            .filter_map(|position| ui_shared::sparse_model::item_at::<SearchItem>(model, position))
            .collect::<Vec<_>>();
