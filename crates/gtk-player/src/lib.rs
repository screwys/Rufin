...
pub struct PlayerUi {
    ...
    navigate: Rc<dyn Fn(gtk_widgets::route::Route)>,
...
impl PlayerUi {
    pub fn new(
        ...
        control_feedback: Rc<gtk_widgets::feedback::ControlFeedbackState>,
        database: std::sync::Arc<library::Database>,
        runtime: tokio::runtime::Handle,
        navigate: Rc<dyn Fn(gtk_widgets::route::Route)>,
        refresh_current_controls: Rc<dyn Fn()>,
    ...
    pub fn replace_player(&self, player: PlaybackView) {
        ...
        if track_changed {
            ...
            gtk_widgets::favorites::set_favorite_button_active(&controls.favorite_button, false);
...
pub fn register_resources() -> Result<(), String> {
    ...
    REGISTERED
        .get_or_init(|| {
            gtk::gio::resources_register_include!("gtk-player.gresource")
