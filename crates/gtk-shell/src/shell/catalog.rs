...
impl Shell {
    pub(super) fn build_catalog(
        ...
        let history_source_name = {
            ...
            source.map(gtk_widgets::source_labels::configured_source_display_name)
        };
        Rc::new(gtk_library::CatalogUi {
            ...
            source_label: {
                ...
                Rc::new(move |source_id| {
                    let Some(shell) = weak.upgrade() else {
                        return gtk_widgets::source_labels::source_display_label(None);
                    };
            ...
            has_current_track: gtk_player::state::current_playback_track(
            ...
            playlist_context_menu: {
                ...
                Rc::new(move |target, playlist, play, position| {
                    if let Some(shell) = weak.upgrade() {
                        gtk_media_menus::media_menus::present_playlist_context_menu(
                            target,
                            &shell.media_menus,
                            playlist,
                            play,
