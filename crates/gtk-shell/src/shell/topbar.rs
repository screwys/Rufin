...
pub(crate) struct Topbar {
    ...
    pub search_session: Rc<gtk_library::SearchSession>,
...
impl Topbar {
    ...
    pub fn new() -> Self {
        ...
        Self {
            ...
            header,
            search,
            search_session: Rc::new(gtk_library::SearchSession::default()),
    ...
    pub fn bind(&self, shell: &Rc<Shell>) {
        ...
        crate::preferences::controller::bind_popover(&shell.preferences, &self.controller);
