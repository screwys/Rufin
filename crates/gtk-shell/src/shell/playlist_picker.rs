...
use gtk_widgets::downloads::OperationFeedback;
use gtk_widgets::interactions::{ADD_TO_PLAYLIST_ICON, ContextMenuSurface};
...
fn populate_context_playlist_picker(
    ...
    let update = gtk_media_menus::playlist_picker::populate_context_playlist_picker(
        root,
