...
use adw::prelude::*;
use gtk_editors::metadata::{MetadataReceiver, build_dialog, metadata_error_dialog};
...
fn present_local_access_recovery(
    ...
    let resource = gtk_editors::ui_resource::METADATA_DIALOG_RESOURCE;
    ...
    gtk_widgets::local_access::mount_metadata_local_access_mapping(
        &shell.products.source,
        &shell.chrome.window,
        &selected.source_id,
        access.as_ref(),
