...
fn present_random_play_dialog_loaded(
    ...
    let dialog: adw::Dialog =
        gtk_widgets::ui_resource::object(&builder, resource, "random_play_dialog");
    let controls = RandomPlayControls {
        limit: gtk_widgets::ui_resource::object(&builder, resource, "limit"),
        min_year_enabled: gtk_widgets::ui_resource::object(&builder, resource, "min_year_enabled"),
        min_year: gtk_widgets::ui_resource::object(&builder, resource, "min_year"),
        max_year_enabled: gtk_widgets::ui_resource::object(&builder, resource, "max_year_enabled"),
        max_year: gtk_widgets::ui_resource::object(&builder, resource, "max_year"),
        genre: gtk_widgets::ui_resource::object(&builder, resource, "genre"),
        played_filter: gtk_widgets::ui_resource::object(&builder, resource, "played_filter"),
    };
    ...
    let play_next: gtk::Button = gtk_widgets::ui_resource::object(&builder, resource, "play_next");
    let play_now: gtk::Button = gtk_widgets::ui_resource::object(&builder, resource, "play_now");
    let play_later: gtk::Button =
        gtk_widgets::ui_resource::object(&builder, resource, "play_later");
    drop(builder);
    ...
    glib::spawn_future_local(async move {
        if matches!(task.await, Ok(true)) {
            ...
            let message: gtk::Label =
                gtk_widgets::ui_resource::object(&builder, resource, "no_matches");
