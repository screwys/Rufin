...
use gtk::prelude::*;
use gtk_widgets::mounted_route::{RouteCurrentTrack, RouteCurrentTrackSelection};
...
pub struct CatalogUi {
    ...
    pub media_menus: Rc<gtk_media_menus::media_menus::MediaMenus>,
    pub selected: Option<rufin_core::runtime::SelectedLibrary>,
    pub source_label: Rc<dyn Fn(Option<&str>) -> (&'static str, String)>,
    pub favorites: Option<Rc<gtk_widgets::favorites::FavoriteSessionState>>,
    ...
    pub playlist_context_menu: Rc<
        dyn Fn(
            &gtk::Widget,
            library::PlaylistRow,
            Option<gtk_media_menus::media_menus::CollectionPlay>,
            Option<(f64, f64)>,
        ),
    >,
    ...
    pub set_favorite_category: Rc<dyn Fn(gtk_widgets::route::CollectionCategory)>,
...
impl CatalogUi {
    ...
    pub fn route_navigation(&self) -> Rc<dyn Fn(gtk_widgets::route::Route)> {
        Rc::clone(&self.media_menus.navigate)
    }
    pub fn navigate(&self, route: gtk_widgets::route::Route) {
    ...
    pub fn register_favorite_button(
        &self,
        key: gtk_widgets::favorites::FavoriteControlKey,
        button: &gtk::Button,
    ) {
    ...
    pub fn register_dynamic_favorite_button(
        &self,
        key: Rc<dyn Fn() -> Option<gtk_widgets::favorites::FavoriteControlKey>>,
        button: &gtk::Button,
    ) {
        if let Some(favorites) = &self.favorites {
    ...
    pub fn set_favorite_with_feedback(
        ...
        if let Some(button) = button {
            gtk_widgets::favorites::set_favorite_button_active(button, favorite);
        }
