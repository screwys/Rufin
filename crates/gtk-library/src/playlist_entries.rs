...
use gtk_widgets::localization::{bind_search_placeholder, localized_column};
...
use crate::playlist_entry_model::{PlaylistEntryModel, PlaylistEntryProjectionRequest};
...
fn playlist_entry_table(
    ...
    let table = dynamic_collection_table(
        ...
        route_column_view_initial_width_with_inset(
            shell,
            crate::route_layout::PRIMARY_ROUTE_HORIZONTAL_INSET,
        ),
    );
...
fn playlist_entry_number_column(
    ...
    factory.connect_setup(move |_, item| {
        ...
        let cell = gtk_widgets::recycled_cells::track_list_row_index_cell(item);
...
fn playlist_entry_image_column(
    ...
    factory.connect_unbind(move |_, item| {
        ...
        if let Some(cell) = list_cell::<RecycledArtworkCell>(item) {
            clear_shell.artwork.clear_artwork_tile(&cell.artwork());
        }
    });
...
fn playlist_entry_title_column(
    ...
    connect_sparse_bind(&factory, move |item| {
        ...
        bind_shell.downloads.bind_download_badge(
            ...
            gtk_widgets::downloads::media_download_badge(&entry.media_uri, entry.is_downloaded),
        );
    ...
    factory.connect_unbind(move |_, item| {
        ...
        if let Some(cell) = list_cell::<RecycledMergedCell>(item) {
            ...
            clear_shell
                .downloads
                .clear_download_badge(&cell.downloaded().expect("playlist title badge"));
            title.set_text("");
            cell.clear_subtitle();
...
struct PlaylistEntryGridCell {
    ...
    shell: Rc<CatalogUi>,
    cover: gtk_widgets::artwork::ArtworkTile,
...
impl PlaylistEntryGridCell {
    fn new(
        ...
        let cover = gtk_widgets::artwork::ArtworkTile::new_elastic_square();
    ...
    fn bind_current_artwork(&self) {
        ...
        self.shell.artwork.bind_artwork_tile(
            ...
            gtk_widgets::artwork::LARGE_COVER_SIZE,
        );
    }
...
fn playlist_entry_field_links(entry: &PlaylistEntryRow, field: LibraryField) -> DetailLinks {
    gtk_widgets::detail_links::metadata_links(
        field,
