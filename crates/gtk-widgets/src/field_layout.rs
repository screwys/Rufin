...
pub fn style_compact_field_row(row: &impl IsA<gtk::Widget>) {
    row.add_css_class("compact-field-row");
}

pub fn compact_field_row_group(row: &impl IsA<gtk::Widget>) -> adw::PreferencesGroup {
...
pub fn install_compact_field_row_responsiveness_at(
    fields: &gtk::Box,
    stack_width: i32,
) -> AllocationOwner {
