...
use ui_player::fullscreen::{FullscreenPlaybackRefresh, fullscreen_playback_refresh};
use ui_player::state::{NowPlayingPresentation, current_playback_media_id};
    ...
    *shell.source.operation.borrow_mut() = operation.clone();
    ...
    match &operation {
        ...
        SourceOperation::Failed {
            ...
            if *add_form {
                if !shell.restore_add_server_dialog_after_failure() {
