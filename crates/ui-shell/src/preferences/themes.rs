use crate::{
    AccentPreference, ThemePreference, application::style::ApplicationAppearance, shell::Shell,
};
use adw::prelude::*;
use rufin_core::themes::Accent;
use std::rc::Rc;

pub(super) fn bind(shell: &Rc<Shell>, builder: &gtk::Builder, resource: &str) {
...
fn accent_factory(accents: &[Accent], show_name: bool) -> gtk::SignalListItemFactory {
    ...
    factory.connect_setup(move |_, object| {
        ...
        let builder = ui_shared::ui_resource::builder(resource);
        ui_shared::objects!(builder, resource, { item: gtk::Box, label: gtk::Label, swatch: gtk::Box });
