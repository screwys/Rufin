...
use ui_player::equalizer::EqualizerSurface;
use ui_player::outputs::audio_output_dropdown;
use ui_player::playback_settings::{
...
use ui_shared::forms::{controlled_selection_row, quality_selection_row, selection_row};
...
pub(crate) fn playback_page(shell: &Rc<Shell>) -> adw::PreferencesPage {
    ...
    let builder = ui_shared::ui_resource::builder(resource);
    let page: adw::PreferencesPage =
        ui_shared::ui_resource::object(&builder, resource, "playback_page");
