...
use rufin_core::settings::{ContextMenuItem, ContextMenuItemSettings};
...
pub(crate) fn configure_context_menus_expander(
    ...
    rating_visible.connect_active_notify(move |switch| {
        ...
        rating_shell.settings.set_app_setting(
            "context menu rating setting",
            is_visible,
            |settings| &mut settings.context_menu.rating_visible,
        );
    });
...
mod tests {
    ...
    use rufin_core::settings::{ContextMenuItem, ContextMenuSettings};
