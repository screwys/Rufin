...
impl KaraokeTiming {
    ...
    pub fn progress(&self, position_millis: i128) -> f64 {
...
impl LyricsTiming {
    pub fn new(lines: &[LyricsLine]) -> Self {
    ...
    pub fn next_after(&self, position: i128, karaoke: bool) -> Option<u64> {
        if karaoke {
            let active = self
                .active_ends
