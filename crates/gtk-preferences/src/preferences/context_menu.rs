...
pub fn configure_context_menus_expander(
    ...
    for (item, id) in [
        ...
        let row: adw::SwitchRow = gtk_widgets::ui_resource::object(builder, resource, id);
        row.set_active(
            shell
                .settings
                .current
    ...
    let rating: adw::SwitchRow =
        gtk_widgets::ui_resource::object(builder, resource, "context_menu_rating_row");
