...
fn present_code_dialog(
    ...
    let builder = gtk_widgets::ui_resource::builder(resource);
    gtk_widgets::objects!(builder, resource, { dialog: adw::Dialog, code_row: gtk::Box, code: gtk::Label, copy: gtk::Button, copy_icon: gtk::Image, approval: gtk::LinkButton, refresh: gtk::Button, status: gtk::Label });
