...
use rufin_core::settings::layout::MIN_TABLE_COLUMN_WIDTH;

const TABLE_TARGET_WIDTH: i32 = 44;
pub const FITTED_TABLE_WIDTH_PADDING: i32 = 2;
...
pub fn fitted_column_widths(base_widths: &[i32], available_width: i32) -> Vec<i32> {
...
impl ColumnViewWidthFit {
    pub fn replace(&self, columns: Vec<(gtk::ColumnViewColumn, i32)>) {
    ...
    pub fn fit_scroller_allocation(&self, scroller: &gtk::ScrolledWindow, allocation_width: i32) {
    ...
    pub fn set_preferred_widths(&self, widths: &[i32]) {
...
pub fn install_column_view_width_fit(
...
pub fn compact_header_text_width(header: &str, min_width: i32) -> i32 {
