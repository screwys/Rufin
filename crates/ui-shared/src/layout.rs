...
pub const LARGE_POPUP_BASE_WIDTH: i32 = 700;
...
pub fn large_popup_content_height(app_height: i32, fallback_height: i32) -> i32 {
    if app_height <= 0 {
...
pub fn large_popup_content_width(base_width: i32) -> i32 {
    (base_width * LARGE_POPUP_WIDTH_NUMERATOR + LARGE_POPUP_WIDTH_DENOMINATOR / 2)
        / LARGE_POPUP_WIDTH_DENOMINATOR
}

pub fn configure_fill_width_clip(scroller: &gtk::ScrolledWindow, vertical_policy: gtk::PolicyType) {
...
pub const WINDOW_CHROME_MARGIN_END: i32 = 8;
